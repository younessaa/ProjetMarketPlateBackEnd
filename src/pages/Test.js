...
//                    <center><div className="latest-product__slider owl-carousel">
//                       <div className="latest-prdouct__slider__item">
//                         <a href="#" className="latest-product__item">
//                           <div className="latest-product__item__pic col-lg-5 col-md-5">
//                             <img src={Annonces.image} alt="" />
//                           </div>
//                           <div className="latest-product__item__text col-lg-6 col-md-6">
//                             <h6>
