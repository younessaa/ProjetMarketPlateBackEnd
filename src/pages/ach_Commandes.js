...
class Commandes extends Component {
  ...
  ImageEspece(e) {
    ...
    if (
      ...
      this.NbrEspece(e, "vache") !== 0 &&
      this.NbrEspece(e, "chevre") !== 0
    ) {
                        ...
                        <div id="anonce" className="product__item">
                          ...
                          >
                            ...
                            <ul className="product__item__pic__hover">
                              {Annonces.isDelivered === true ? (
                                <li>
                                  ...
                                  >
                                    {" "}
                                    <a
                                      onClick={this.local.bind(this, Annonces)}
                                    >
                                      {Annonces.statut ===
                                        "en attente de paiement avance" ||
                                      Annonces.statut ===
                              ...
                              (Annonces.ancien_statut === "avarié_changement" &&
                                ...
                                <li>
                                  <a
                                    onClick={(e) => this.handelDelete(Annonces)}
                                  >
                          ...
                          <div
                            ...
                            style={
                              titre === "annulées"
                                ? {
                                    height: 220 - -this.NbrEspeceMax() * 40,
                                ...
                                : titre === "Prêt à livrer"
                                ? {
                                    height: 320 - -this.NbrEspeceMax() * 40,
                                    backgroundRepeat: "no-repeat",
                                    backgroundImage:
                                      Annonces.statut === "avarié"
                                        ? "linear-gradient(rgb(255,153,153), rgb(255,204,204))"
                                ...
                                : {
                                    height: 270 - -this.NbrEspeceMax() * 40,
                                    backgroundRepeat: "no-repeat",
                                    backgroundImage:
                                      Annonces.statut === "avarié"
                                        ? "linear-gradient(rgb(255,153,153), rgb(255,204,204))"
                          ...
                          >
                            ...
                            "commande annulée (deadline dépassé)" ? (
                              <div className="float-right text-danger">
                                <i
                                  className="fa fa-exclamation-circle fa-xs"
                                  aria-hidden="true"
                                ></i>{" "}
                                Délai dépassé
                              </div>
                            ...
                            Annonces.statut ===
                              ...
                              <div className="float-right text-warning">
                                <i
                                  className="fa fa-hourglass-start fa-xs"
                                  aria-hidden="true"
                                ></i>
                            ...
                            {Annonces.especes.length === 1 ? (
                              ...
                              <p>
                                <h6 className="mb-0">
                                  {this.NbrEspece(Annonces, "mouton") !== 0 ? (
                                ...
                                <h6 className="mb-0">
                                  {this.NbrEspece(Annonces, "vache") !== 0 ? (
                                    <span className="w-100">
                                ...
                                <h6 className="mb-0">
                                  {" "}
                                  {this.NbrEspece(Annonces, "chevre") !== 0 ? (
                                    <span className="w-100">
                            ...
                            this.Min(Annonces, "poids") ? (
                              ...
                              <p>
                                ...
                                <span style={{ color: "black" }}>
                                  entre : {this.Max(Annonces, "poids")} Kg et{" "}
                            ...
                            this.Min(Annonces, "age") ? (
                              ...
                              <p>
                                ...
                                >
                                  entre : {this.Max(Annonces, "age")} mois et{" "}
                            ...
                            "en attente de validation avance" ? (
                              <div>
                                ...
                                <p className="text-danger font-weight-bold mt-0">
                                  {" "}
                                  {Annonces.avance_transmis_le.substr(0, 10) +
                                    " à " +
                                    Annonces.avance_transmis_le.substr(11, 8)}
                                </p>
                              </div>
                            ) : null}
                            {Annonces.statut ===
                            ...
                            (Annonces.statut === "avarié_changement" &&
                              ...
                              <div>
                                ...
                                <p className="text-danger font-weight-bold mt-0">
                                  {Annonces.reste_transmis_le.substr(0, 10) +
                                    " à " +
                                    Annonces.reste_transmis_le.substr(11, 8)}
                                </p>
                              </div>
                            ) : null}
                            {Annonces.statut === "validé" &&
