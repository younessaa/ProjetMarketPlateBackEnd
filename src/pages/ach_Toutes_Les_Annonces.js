                                ...
                                <div className="sidebar__item">
                                    ...
                                    <div class="row">
                                      <div class="col-lg-6 col-md-6">
                                          <input type="text" class="latest-product__item" placeholder="Budget min" />
                                      </div>
                                    </div>
                                    <div class="row">
                                      <div class="col-lg-6 col-md-6">
                                          <input type="text" class="latest-product__item" placeholder="Budget max" />
                                      </div>
                                    </div>
                                    ...
                                    <div class="row">
                                      <div class="col-lg-6 col-md-6">
                                          <input type="text" class="latest-product__item" placeholder="Choisissez la race" />
                                      </div>
                                    </div>
                                    ...
                                    <div class="row">
                                      <div class="col-lg-6 col-md-6">
                                          <input type="text" class="latest-product__item" placeholder="Poids approximatif" />
                                      </div>
                                    </div>
                                    ...
                                    <div class="row">
                                      <div class="col-lg-6 col-md-6">
                                          <input type="text" class="latest-product__item" placeholder="Ville" />
                                      </div>
                                    </div>
